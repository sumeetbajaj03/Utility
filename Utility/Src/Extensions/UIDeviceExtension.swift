...
//  Utility
//
//  Created by Sumeet Bajaj on 20/04/2020.
//
...
public extension UIDevice {
    ...
    var isLandscape:Bool {
        return self.orientation.isLandscape
    }
    
    var isPortrait:Bool {
        return self.orientation.isPortrait
    }
}
...
public extension UIDevice {
    ...
    func diskSizeInBytes(type:SizeType) -> Int64 {
        
        switch type {
            case .total: return self.totalDiskSpaceInBytes()
            case .free : return self.freeDiskSpaceInBytes()
